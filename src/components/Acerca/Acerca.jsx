        ...
        <div className='contain-acerca_info'>
          ...
          <div className='contain-acerca_info_prrContain'>
            <p className='contain-acerca_info_prr'>
              Hola, mi nombre es Andrés Carlosama, soy diseñador gráfico con 4
              años de experiencia en diseño de piezas para redes sociales,
              animación, edición de video, diseño de interfaces web, ilustración
              entre otras actividades relacionadas con el diseño gráfico y
              diseño web.
            </p>
